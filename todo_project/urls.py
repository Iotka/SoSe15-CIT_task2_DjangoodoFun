...
urlpatterns = patterns('',
   ...
   # url(r'^add/$', views.add, name='add'), 
	...
	url(r'^delete/(?P<pk>[0-9]+)', views.TaskDelete.as_view(),name='update_delete'),
    url(r'^delete/*/*', views.index, name='index'),
    url(r'^finish/(?P<pk>[0-9]+)/$', views.TaskFinish.as_view(),name='update_finish'),
)
